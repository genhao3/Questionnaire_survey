            ...
            <el-row>
              <el-col :span="24">
                <el-input
                  ...
                  type="textarea"
                  :rows="5"
                  v-model="addTextareaForm.options[index]"
                ></el-input>
              </el-col>
            </el-row>
          </div>
...
=======
  ...
  methods: {
    addRadio: function(type) {
      //打开添加单选题弹框
      this.radioVisible = true;
      this.addRadioForm.type = type;
    },
    addCheckbox: function(type) {
      //打开添加多选题弹框
      this.checkboxVisible = true;
      this.addCheckboxForm.type = type;
    },
    addTextarea: function(type) {
      //打开添加填空题弹框
      this.textareaVisible = true;
      this.addTextareaForm.type = type;
    },
...
=======
    ...
    addRadioList: function(addRadioForm) {
      // 添加单选题
    ...
    addCheckboxList: function(addCheckboxForm) {
      //添加多选题
...
>>>>>>> c300b791ea52bced18d84e182bd5a2544b139793
    ...
    addTextareaList: function(addTextareaForm) {
      //添加填空题
